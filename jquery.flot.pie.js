...
if (options.series.pie.innerRadius.radius > 0) {
// subtract the center
layer.save();
var innerRadius = options.series.pie.innerRadius.radius > 1 ? options.series.pie.innerRadius.radius : maxRadius * options.series.pie.innerRadius.radius;
var iText = options.series.pie.innerRadius.text;
var iColor = options.series.pie.innerRadius.color;
var iBgColor = options.series.pie.innerRadius.bgcolor;
...
layer.fillStyle = iBgColor;
layer.arc(0, 0, innerRadius, 0, Math.PI * 2, false);
layer.stroke();
layer.closePath();
var text = iText;
layer.fill();
layer.fillStyle = iColor;
var font = "bold 20px serif";
layer.font = font;
var width = layer.measureText(text).width;
var height = layer.measureText("w").width;
layer.fillText(text, 0 - (width/2) , 0 + (height/2));
layer.restore();
